var canvas,bg,tom,jerry,tomImage1,tomImage2,tomImage3,jerryImage1, jerryImage2,jerryImage3
...
tom.velocityX = 0
tom.addAnimation("tomtli",tomImage3)
tom.x = 300
tom.scale = 0.2
tom.changeAnimation("tomtli")
jerry.addAnimaton("jerrytli",jerryImage3)
jerry.scale = 0.15
jerry.changeAnimation("jerrytli")
}
    drawSprites();
}
